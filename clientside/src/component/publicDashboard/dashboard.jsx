...
function Dashboard() {
  ...
  const handleSearch = () => {
    axios
      .get(`http://localhost:1997/search?s=${query}`)
  ...
  useEffect(() => {
    axios
      .get("http://localhost:1997/newPrivateGroup")
  ...
  const createGroup = () => {
    ...
    axios
      .post("http://localhost:1997/newGroup", payload)
        ...
        <div className="container">
          <div className="profiles">
            ...
            <div className="newone">
              {loginedUserId?.username[0].toUpperCase()}
            </div>
